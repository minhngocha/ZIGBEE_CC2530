...
#if ROUTER == ROUTER_1
#define CHECK_ROUTER  '1'
#endif //#if ROUTER == ROUTER_1

#if ROUTER == ROUTER_2
#define CHECK_ROUTER  '2'
#endif //#if ROUTER == ROUTER_2

#if ROUTER == ROUTER_3
#define CHECK_ROUTER  '3'
#endif //#if ROUTER == ROUTER_3
...
#endif // #if ZSTACK_DEVICE_BUILD  ==   DEVICE_BUILD_ROUTER
      //    }
      //    else
      //    {
      //      stat = OTA_DUP_MSG;
